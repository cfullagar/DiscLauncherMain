...
import frc.robot.subsystems.ConveyorMotor;
...
public class Robot extends TimedRobot {
  ...
  public static DiscPusherWiperMotor snowPush = new DiscPusherWiperMotor();
  public static ConveyorMotor conveyor = new ConveyorMotor();
